    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unique', models.BooleanField(default=True, verbose_name='Unique')),
                ('method', models.IntegerField(choices=[(1, 'Auto'), (0, 'Manual')], help_text='Verification method', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secured', models.BooleanField(default=False, verbose_name='Secured')),
                ('required', models.BooleanField(default=False, verbose_name='Required')),
                ('content_type', models.ManyToManyField(blank=True, limit_choices_to=models.Q(app_label='person'), related_name='person_attibute', to='contenttypes.ContentType')),
                ('option_group', models.ForeignKey(blank=True, help_text='Select option group if using type "Option" or "Multi Option"', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='content_attributes', to='person.AttributeOptionGroup', verbose_name='Option Group')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.ForeignKey(blank=True, limit_choices_to=models.Q(app_label='person'), null=True, on_delete=django.db.models.deletion.CASCADE, related_name='person_entity_attibutes', to='contenttypes.ContentType')),
